...
import { filterType, filterPrice, filterAcreage } from '../../ultils/filter';
    ...
    return (
        <>
            <div className="p-[10px] w-3/5 my-3 bg-[#febb02] rounded-lg flex-col lg:flex-row flex items-center justify-around gap-2">
                <span
                    onClick={() => handleShowModal(filterType, 'category', 'Tìm tất cả')}
                ...
                <span
                    onClick={() => handleShowModal(filterPrice, 'price', 'Chọn giá')}
                    className="cursor-pointer flex-1"
                >
                    <SearchItem
                ...
                <span
                    onClick={() => handleShowModal(filterAcreage, 'area', 'Chọn diện tích')}
                    className="cursor-pointer flex-1"
                >
                    <SearchItem
